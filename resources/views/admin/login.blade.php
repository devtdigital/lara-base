...
{{--         class="absolute top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2" width="100%">--}}
...
{{--         class="absolute top-1/2 left-1/2 max-w-none -translate-x-1/2 -translate-y-1/2" width="1308">--}}
    <div
        class="absolute inset-0 bg-[url(https://play.tailwindcss.com/img/grid.svg)] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]"></div>
